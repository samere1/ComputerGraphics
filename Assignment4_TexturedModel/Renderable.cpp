...
Renderable::Renderable() : vbo_(QOpenGLBuffer::VertexBuffer), ibo_(QOpenGLBuffer::IndexBuffer), texture_(QOpenGLTexture::Target2D), numIndices_(0), vertexSize_(0), rotationAxis_(0.0, 0.0, 1.0), rotationSpeed_(0.1)
{
  rotationAngle_ = 0.0;
}
...
void Renderable::draw(const QMatrix4x4 &view, const QMatrix4x4 &projection, bool wireframe)
{
